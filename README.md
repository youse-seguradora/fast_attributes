...
To bypass the error and ignore the attribute when initialize, you can use `ignore_undefined: true`.

```ruby
class Book
  extend FastAttributes

  define_attributes initialize: true, ignore_undefined: true do
    attribute :author, String
  end
end
